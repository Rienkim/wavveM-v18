...
class oo00 (object):
  ...
  def Request2(self, url, params=None, postdata=None):
    ...
    if postdata:
      II1Iiii1111i = requests.post(
          url, headers=Oo0o0ooO0oOOO, params=params, data=postdata)
    else:
...
class iII111ii (object):
  ...
  def GetDefaultParams(self):
    ...
    return O0O00Ooo
    if 64 - 64:
      oO0o - O0 / II111iiii / o0oOOo0O0Ooo / iIii1I11I1II1
  ...
  def GetGUID(self, guid_str='POOQ', guidType=1):
    ...
    if guidType == 2:
      III1i1i = '%s-%s-%s-%s-%s' % (III1i1i[: 8], III1i1i[8: 12],
                                    III1i1i[12: 16], III1i1i[16: 20], III1i1i[20:])
    return III1i1i
  ...
  def GetHash(self, hash_str):
    ...
    if 13 - 13:
      O00oOoOoO0o0O + OoOoOO00 - OoooooooOO + O0oo0OO0.iii1I1I + OoO0O00

  def CheckQuality(self, sel_qt, qt_list):
    Ii = 0
    for oo0O0oOOO00oO in qt_list:
      if sel_qt >= oo0O0oOOO00oO:
  ...
  def GetCredential(self, user_id, user_pw, user_pf):
    ...
    try:
      ...
      oo = {'id': user_id, 'password': user_pw, 'profile': '0', 'pushid': '', 'type': 'general'
            }
      IiIIIiI1I1 = self.MakeServiceUrl(Oo000, O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(
          IiIIIiI1I1, postdata=urllib.urlencode(oo))
      OOOO = json.loads(II1Iiii1111i)
      i11i1 = OOOO['credential']
      if user_pf != 0:
        oo = {'id': i11i1, 'password': '', 'profile': str(user_pf), 'pushid': '', 'type': 'credential'
              }
        II1Iiii1111i = self.SESSION.Request(
            IiIIIiI1I1, postdata=urllib.urlencode(oo))
        OOOO = json.loads(II1Iiii1111i)
  ...
  def GetGnList(self, gn_str):
    ...
    try:
      ...
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not ('multisectionlist' in OOOO):
        return None
      OOO0o = OOOO['multisectionlist']
      for O0oOO0 in OOO0o:
        O0ooo0O0oo0 = O0oOO0['title']
        if len(O0ooo0O0oo0) == 0:
          continue
        if O0ooo0O0oo0 == 'minor':
          continue
        if re.search(u'베너', O0ooo0O0oo0):
          continue
        O0ooo0O0oo0 = re.sub('\n|\!|\~|(@0@)|(@\^0@)', '', O0ooo0O0oo0)
        O0ooo0O0oo0 = O0ooo0O0oo0.lstrip('#')
        for O0O in O0oOO0['eventlist'][0]['bodylist']:
          if re.search(r'uicode:', O0O):
            ooo0OO = {'title': unicode(O0ooo0O0oo0), 'uicode': re.sub(r'uicode:', '', O0O)
                      }
  ...
  def GetDeeplinkList(self, gn_str, came_str, page_int, addinfoyn=False):
    ...
    try:
      ...
      if 'contenttype' in I11i1ii1:
        i1I1ii = I11i1ii1['contenttype']
      if came_str == 'movie':
        I11i1ii1['mtype'] = 'svod'
      if page_int != 1:
        I11i1ii1['offset'] = str((page_int - 1) * self.LIST_LIMIT)
        I11i1ii1['page'] = str(page_int)
      IiIIIiI1I1 = self.HTTPTAG + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not ('celllist' in OOOO['cell_toplist']):
      ...
      for O0oOO0 in oO00OOoO00:
        ...
        if (O0oOO0.get('thumbnail') != ''):
          i1I1ii11i1Iii = 'https://%s' % O0oOO0.get('thumbnail')
        ...
        try:
          if ('channelid' in OOOO0oo0):
            oO['mediatype'] = 'video'
            oO['title'] = '%s < %s >' % (
                unicode(O0ooO0Oo00o), unicode(ooO0oOOooOo0))
          ...
          None
        ooo0OO = {'title': unicode(O0ooO0Oo00o), 'subtitle': unicode(ooO0oOOooOo0), 'thumbnail': i1I1ii11i1Iii, 'uicode': i1I1ii, 'contentid': oOOo0, 'contentidType': oo00O00oO, 'viewage': O0oOO0.get('age'), 'channelepg': iIiIIIi, 'info': oO
                  }
        iiIii.append(ooo0OO)
      ooo0O = int(OOOO['cell_toplist']['pagecount'])
      if OOOO['cell_toplist']['count']:
        oOoO0o00OO0 = int(OOOO['cell_toplist']['count'])
      else:
        oOoO0o00OO0 = self.LIST_LIMIT
    ...
    try:
      if iiIii[0].get('contentidType') == 'movieid' and addinfoyn == True:
        ...
        I111iI = {}
        for O0oO in iiIii:
          Oo0O0oooo.append(O0oO.get('contentid'))
        I111iI = self.GetMovieInfoList(Oo0O0oooo)
        for O0O00o0OOO0 in range(len(iiIii)):
          iiIii[O0O00o0OOO0]['info'] = I111iI.get(
              iiIii[O0O00o0OOO0]['contentid'])
    except:
      None
    return (iiIii, ooo00OOOooO)
  ...
  def GetEpisodeList(self, contentid, contenttype, contentidType, page_int, orderby='desc'):
    ...
    try:
      ...
      if contentidType == 'contentid':
        ...
        II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
        OOOO = json.loads(II1Iiii1111i)
        if not ('programid' in OOOO):
          return None
        O00oO000O0O = OOOO['programid']
      else:
        O00oO000O0O = contentid
      Oo000 = '/vod/programs-contents/' + O00oO000O0O
      I11i1ii1 = {'limit': self.EP_LIMIT, 'offset': str((page_int - 1) * self.EP_LIMIT), 'orderby': orderby
                  }
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not ('list' in OOOO):
      ...
      for O0oOO0 in ooOoO00:
        ...
        Oo0o00OO0000 = '%s회, %s(%s)' % (O0oOO0.get('episodenumber'), O0oOO0.get(
            'releasedate'), O0oOO0.get('releaseweekday'))
        if (O0oOO0.get('image') != ''):
          I1i = 'https://%s' % O0oOO0.get('image')
        ...
        try:
          if 'episodenumber' in O0oOO0:
            oO['episode'] = O0oOO0.get('episodenumber')
          if 'releasedate' in O0oOO0:
            oO['year'] = int(O0oOO0.get('releasedate')[: 4])
          if 'releasedate' in O0oOO0:
            oO['aired'] = O0oOO0.get('releasedate')
          if 'playtime' in O0oOO0:
            oO['duration'] = O0oOO0.get('playtime')
          if 'episodeactors' in O0oOO0:
            if O0oOO0.get('episodeactors') != '':
              oO['cast'] = O0oOO0.get('episodeactors').split(',')
        except:
          None
        iiii1 = {'title': unicode(II11Ii1iI1iII), 'subtitle': unicode(Oo0o00OO0000), 'thumbnail': I1i, 'uicode': contenttype, 'contentid': O0oOO0.get('contentid'), 'programid': O0oOO0.get('programid'), 'synopsis': i11I, 'viewage': O0oOO0.get('targetage'), 'info': oO
                 }
        OOOoOo.append(iiii1)
      ooo0O = int(OOOO['pagecount'])
      if OOOO['count']:
        oOoO0o00OO0 = int(OOOO['count'])
      else:
        oOoO0o00OO0 = self.EP_LIMIT
      ooo00OOOooO = ooo0O > oOoO0o00OO0
    except Exception as oO0ooO0OoOOOO:
      print(oO0ooO0OoOOOO)
  ...
  def GetMyviewList(self, contenttype, page_int, addinfoyn=False):
    ...
    try:
      ...
      I11i1ii1 = {'contenttype': contenttype, 'limit': self.MV_LIMIT, 'offset': str((page_int - 1) * self.MV_LIMIT), 'orderby': 'new'
                  }
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not ('list' in OOOO[0]):
        return None
      ii = OOOO[0]['list']
      for O0oOO0 in ii:
        oO = {}
        if contenttype == 'vod':
          II11Ii1iI1iII = O0oOO0.get('programtitle')
          Oo0o00OO0000 = '%s회, %s' % (O0oOO0.get(
              'episodenumber'), O0oOO0.get('releasedate'))
        ...
        if (O0oOO0.get('image') != ''):
          I1i = 'https://%s' % O0oOO0.get('image')
        IiIi1I1 = {'title': unicode(II11Ii1iI1iII), 'subtitle': unicode(Oo0o00OO0000), 'thumbnail': I1i, 'uicode': contenttype, 'contentid': oOOo0, 'programid': O00oO000O0O, 'viewage': O0oOO0.get('targetage'), 'info': oO
                   }
        ooOOOooO.append(IiIi1I1)
      ooo0O = int(OOOO[0]['pagecount'])
      if OOOO[0]['count']:
        oOoO0o00OO0 = int(OOOO[0]['count'])
      else:
        oOoO0o00OO0 = self.MV_LIMIT
      ooo00OOOooO = ooo0O > oOoO0o00OO0
    except Exception as oO0ooO0OoOOOO:
      print(oO0ooO0OoOOOO)
    try:
      if contenttype == 'movie' and addinfoyn == True:
        Oo0O0oooo = []
        I111iI = {}
        for O0oO in ooOOOooO:
          Oo0O0oooo.append(O0oO.get('contentid'))
        I111iI = self.GetMovieInfoList(Oo0O0oooo)
        for O0O00o0OOO0 in range(len(ooOOOooO)):
          ooOOOooO[O0O00o0OOO0]['info'] = I111iI.get(
              ooOOOooO[O0O00o0OOO0]['contentid'])
    except:
      None
  ...
  def GetSearchList(self, search_key, genre, page_int, exclusion21=False, addinfoyn=False):
    ...
    try:
      ...
      I11i1ii1 = {'type': 'program' if genre == 'vod' else 'movie', 'keyword': search_key, 'offset': str((page_int - 1) * self.LIST_LIMIT), 'limit': self.LIST_LIMIT, 'orderby': 'score', 'isplayymovie': 'y'
                  }
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      ...
      for O0oOO0 in IIiI1Ii:
        ...
        if (O0oOO0.get('thumbnail') != ''):
          I1i = 'https://%s' % O0oOO0.get('thumbnail')
        for O0O in O0oOO0['event_list'][0]['bodylist']:
          if re.search(r'uicode:', O0O):
            ...
            oO['mpaa'] = O0oOO0.get('age')
            IiIi1I1 = {'title': unicode(II11Ii1iI1iII), 'thumbnail': I1i, 'uicode': genre, 'contentid': oOOo0, 'programid': O00oO000O0O, 'viewage': O0oOO0.get('age'), 'info': oO
                       }
    ...
    try:
      if genre == 'movie' and addinfoyn == True:
        Oo0O0oooo = []
        I111iI = {}
        for O0oO in iIiIiIiI:
          Oo0O0oooo.append(O0oO.get('contentid'))
        I111iI = self.GetMovieInfoList(Oo0O0oooo)
        for O0O00o0OOO0 in range(len(iIiIiIiI)):
          iIiIiIiI[O0O00o0OOO0]['info'] = I111iI.get(
              iIiIiIiI[O0O00o0OOO0]['contentid'])
    except:
      None
    return iIiIiIiI, ooo00OOOooO
  ...
  def GetGenreGroup(self, maintype, subtype, orderby, ordernm, exclusion21=False):
    ...
    try:
      ...
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not (maintype in OOOO):
        return None
      iIi1Ii1i1iI = OOOO[maintype]
      if subtype == '-':
        for O0oOO0 in iIi1Ii1i1iI:
          ii111IiiI1 = dict(urlparse.parse_qsl(
              urlparse.urlsplit(O0oOO0.get('url')).query))
          IiIi1I1 = {'title': O0oOO0.get('text'), 'genre': O0oOO0.get('id'), 'subgenre': '-', 'adult': O0oOO0.get('adult'), 'broadcastid': ii111IiiI1.get('broadcastid'), 'contenttype': ii111IiiI1.get('contenttype'), 'uiparent': ii111IiiI1.get('uiparent'), 'uirank': ii111IiiI1.get('uirank'), 'uitype': ii111IiiI1.get('uitype'), 'orderby': orderby, 'ordernm': ordernm
                     }
        ...
        for O0oOO0 in iIi1Ii1i1iI:
          if O0oOO0.get('id') == subtype:
            for II in O0oOO0['sublist']:
              ...
              IiIi1I1 = {'title': II.get('text'), 'genre': subtype, 'subgenre': II.get('id'), 'adult': II.get('adult'), 'broadcastid': ii111IiiI1.get('broadcastid'), 'contenttype': ii111IiiI1.get('contenttype'), 'uiparent': ii111IiiI1.get('uiparent'), 'uirank': ii111IiiI1.get('uirank'), 'uitype': ii111IiiI1.get('uitype'), 'orderby': orderby, 'ordernm': ordernm
                         }
              iiIi1i.append(IiIi1I1)
            break
    except Exception as oO0ooO0OoOOOO:
  ...
  def GetGenreGroup_sub(self, in_params):
    ...
    try:
      ...
      I11i1ii1 = {'WeekDay': 'all', 'limit': '20', 'offset': '0', 'orderby': in_params.get('orderby'), 'adult': in_params.get('adult'), 'broadcastid': in_params.get('broadcastid'), 'contenttype': in_params.get('contenttype'), 'genre': in_params.get('genre'), 'uiparent': in_params.get('uiparent'), 'uirank': in_params.get('uirank'), 'uitype': in_params.get('uitype')
                  }
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      II1Iiii1111i = self.SESSION.Request(IiIIIiI1I1)
      OOOO = json.loads(II1Iiii1111i)
      if not ('filter_item_list' in OOOO['filter']['filterlist'][1]):
        return None
      iIi1Ii1i1iI = OOOO['filter']['filterlist'][1]['filter_item_list']
      for O0oOO0 in iIi1Ii1i1iI:
        IiIi1I1 = {'broadcastid': in_params.get('broadcastid'), 'contenttype': in_params.get('contenttype'), 'genre': in_params.get('genre'), 'uiparent': in_params.get('uiparent'), 'uirank': in_params.get('uirank'), 'uitype': in_params.get('uitype'), 'adult': O0oOO0.get('adult'), 'title': O0oOO0.get('title'), 'subgenre': O0oOO0.get('api_parameters')[O0oOO0.get('api_parameters').find('=') + 1:], 'orderby': in_params.get('orderby')
                   }
        iiIi1i.append(IiIi1I1)
    except Exception as oO0ooO0OoOOOO:
      print(oO0ooO0OoOOOO)
  ...
  def GetGenreList(self, genre, in_params, page_int, addinfoyn=False):
    ...
    try:
      O0O00Ooo = self.GetDefaultParams()
      I11i1ii1 = {'WeekDay': 'all', 'adult': in_params.get('adult'), 'broadcastid': in_params.get('broadcastid'), 'contenttype': in_params.get('contenttype'), 'genre': in_params.get('genre'), 'orderby': in_params.get('orderby'), 'uiparent': in_params.get('uiparent'), 'uirank': in_params.get('uirank'), 'uitype': in_params.get('uitype')
                  }
      if genre == 'vodgenre':
        Oo000 = '/cf/vod/newcontents'
        ...
        for O0O in O0oOO0['event_list'][0]['bodylist']:
          if re.search(r'uicode:', O0O):
            ...
            if genre == 'moviegenre_svod':
              ...
              oO['mediatype'] = 'episode'
            IiIi1I1 = {'title': unicode(II11Ii1iI1iII), 'uicode': re.sub(r'uicode:', '', O0O), 'thumbnail': I1i, 'viewage': O0oOO0.get('age'), 'info': oO
                       }
        iiIi1i.append(IiIi1I1)
      ooo0O = int(OOOO['cell_toplist']['pagecount'])
      if OOOO['cell_toplist']['count']:
    ...
    try:
      if genre == 'moviegenre_svod' and addinfoyn == True:
        ...
        I111iI = {}
        for O0oO in iiIi1i:
          Oo0O0oooo.append(O0oO.get('uicode'))
        I111iI = self.GetMovieInfoList(Oo0O0oooo)
        for O0O00o0OOO0 in range(len(iiIi1i)):
          iiIi1i[O0O00o0OOO0]['info'] = I111iI.get(
              iiIi1i[O0O00o0OOO0]['uicode'])
    except:
      None
  ...
  def GetEPGList(self, genre):
    ...
    try:
      ...
      O0O00Ooo = self.GetDefaultParams()
      I11i1ii1 = {'limit': '100', 'offset': '0', 'genre': genre, 'startdatetime': I1iIIIi1.strftime('%Y-%m-%d %H:%M'), 'enddatetime': Iii.strftime('%Y-%m-%d %H:%M')
                  }
      Oo000 = '/live/epgs'
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(I11i1ii1) + '&' + urllib.urlencode(O0O00Ooo)
      ...
      for O0oOO0 in iIiii:
        ...
        for IiIIiiI11III in O0oOO0['list']:
          ...
          I111 += ' [%s ~ %s]' % (IiIIiiI11III['starttime']
                                  [- 5:], IiIIiiI11III['endtime'][- 5:]) + '\n'
  ...
  def GetMovieInfoList(self, movie_list):
    ...
    try:
      ...
      for O0oO in movie_list:
        ...
        oO['mediatype'] = 'movie'
        o00 = []
        for OO00O0oOO in OOOO['actors']['list']:
          o00.append(OO00O0oOO.get('text'))
        if o00[0] != '':
          oO['cast'] = o00
        Ooooo00o0OoO = []
        for oooo0O0O0o0 in OOOO['directors']['list']:
          Ooooo00o0OoO.append(oooo0O0O0o0.get('text'))
        if Ooooo00o0OoO[0] != '':
          oO['director'] = Ooooo00o0OoO
        iiIi1i = []
        for OOoOoo0 in OOOO['genre']['list']:
          iiIi1i.append(OOoOoo0.get('text'))
        if iiIi1i[0] != '':
          oO['genre'] = iiIi1i
  ...
  def GetStreamingURL(self, contentid, contenttype, quality_int):
    ...
    try:
      ...
      Oo000 = '/streaming'
      I11i1ii1 = {'contentid': contentid, 'contenttype': II1i1i1iII1, 'action': IioO0O, 'quality': str(O0OoOoO00O) + 'p', 'deviceModelId': 'Windows 10', 'guid': self.GetGUID(guidType=2), 'lastplayid': self.guid, 'authtype': 'cookie', 'isabr': 'y', 'ishevc': 'n'
                  }
      IiIIIiI1I1 = self.API_DOMAIN + Oo000 + '?' + \
          urllib.urlencode(O0O00Ooo) + '&' + urllib.urlencode(I11i1ii1)
      ...
      ii1iiIi1 = OOOO['drm']
      if 'previewmsg' in OOOO['preview']:
        i111iiI1ii = OOOO['preview']['previewmsg']
    except Exception as oO0ooO0OoOOOO:
      print(oO0ooO0OoOOOO)
